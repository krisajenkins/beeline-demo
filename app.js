...
Elm.FindAddress.Main.make = function (_elm) {
   "use strict";
   _elm.FindAddress = _elm.FindAddress || {};
   _elm.FindAddress.Main = _elm.FindAddress.Main || {};
   if (_elm.FindAddress.Main.values)
   return _elm.FindAddress.Main.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
                   ...
                   ,_1: function () {
                      ...
                      {case "Just":
                         return A2($Effects.map,
                           $FindAddress$Schema.SearchCandidates,
                           findCandidates(_v4._0));
                         case "Nothing":
                         return $Effects.none;}
                      _U.badCase($moduleName,
...
Elm.FindAddress = Elm.FindAddress || {};
Elm.FindAddress.Schema = Elm.FindAddress.Schema || {};
Elm.FindAddress.Schema.make = function (_elm) {
   "use strict";
   _elm.FindAddress = _elm.FindAddress || {};
   _elm.FindAddress.Schema = _elm.FindAddress.Schema || {};
   if (_elm.FindAddress.Schema.values)
   return _elm.FindAddress.Schema.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "FindAddress.Schema",
   $Basics = Elm.Basics.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var decodeLocation = A2($Json$Decode$Extra.apply,
   A2($Json$Decode.map,
   $Geometry.LatLng,
   A2($Json$Decode._op[":="],
   "y",
   ...
   var ChooseCandidate = function (a) {
      return {ctor: "ChooseCandidate"
             ,_0: a};
   };
   var SearchCandidates = function (a) {
      return {ctor: "SearchCandidates"
             ,_0: a};
   };
   var Submit = {ctor: "Submit"};
   var TermChange = function (a) {
   ...
   var decodeAttributes = A2($Json$Decode.map,
   Attributes,
   A2($Json$Decode._op[":="],
   "City",
   $Json$Decode.string));
   var decodeCandidate = A2($Json$Decode$Extra.apply,
   ...
   _elm.FindAddress.Schema.values = {_op: _op
                                    ...
                                    ,decodeFindAddressCandidates: decodeFindAddressCandidates};
   return _elm.FindAddress.Schema.values;
};
Elm.FindAddress = Elm.FindAddress || {};
Elm.FindAddress.View = Elm.FindAddress.View || {};
Elm.FindAddress.View.make = function (_elm) {
   "use strict";
   _elm.FindAddress = _elm.FindAddress || {};
   _elm.FindAddress.View = _elm.FindAddress.View || {};
   if (_elm.FindAddress.View.values)
   ...
   candidate) {
      return function () {
         ...
         _L.fromArray([$Html$Attributes.$class("list-group-item")
                      ...
                      uiChannel,
                      $FindAddress$Schema.ChooseCandidate(candidate))]),
   ...
   var resultsList = F3(function (uiChannel,
   currentLocation,
   candidates) {
      return A2($Html.ul,
   ...
   var rootView = F3(function (uiChannel,
   currentLocation,
   model) {
      return A2($Html.div,
      _L.fromArray([]),
      _L.fromArray([A2($Html.h3,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Search for a destination")]))
                   ,A2(searchForm,uiChannel,model)
                   ,function () {
                      var _v2 = model.candidates;
                      switch (_v2.ctor)
                      {case "Just":
                         switch (_v2._0.ctor)
                           {case "Err":
...
Elm.Main.make = function (_elm) {
   ...
   function (v) {
      return v === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v === "object" && "code" in v && "message" in v ? {_: {}
                                                                                                                                            ,code: typeof v.code === "number" ? v.code : _U.badPort("a number",
                                                                                                                                            v.code)
                                                                                                                                            ,message: typeof v.message === "string" || typeof v.message === "object" && v.message instanceof String ? v.message : _U.badPort("a string",
                                                                                                                                            v.message)} : _U.badPort("an object with fields `code`, `message`",
      v));
   });
   var geolocationSignal = Elm.Native.Port.make(_elm).inboundSignal("geolocationSignal",
   "Maybe.Maybe Schema.Position",
   function (v) {
      return v === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v === "object" && "coords" in v && "timestamp" in v ? {_: {}
                                                                                                                                                ,coords: typeof v.coords === "object" && "accuracy" in v.coords && "altitude" in v.coords && "altitudeAccuracy" in v.coords && "heading" in v.coords && "latitude" in v.coords && "longitude" in v.coords && "speed" in v.coords ? {_: {}
                                                                                                                                                                                                                                                                                                                                                                                   ,accuracy: typeof v.coords.accuracy === "number" ? v.coords.accuracy : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                   v.coords.accuracy)
                                                                                                                                                                                                                                                                                                                                                                                   ,altitude: v.coords.altitude === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v.coords.altitude === "number" ? v.coords.altitude : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                   v.coords.altitude))
                                                                                                                                                                                                                                                                                                                                                                                   ,altitudeAccuracy: v.coords.altitudeAccuracy === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v.coords.altitudeAccuracy === "number" ? v.coords.altitudeAccuracy : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                   v.coords.altitudeAccuracy))
                                                                                                                                                                                                                                                                                                                                                                                   ,heading: v.coords.heading === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v.coords.heading === "number" ? v.coords.heading : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                   v.coords.heading))
                                                                                                                                                                                                                                                                                                                                                                                   ,latitude: typeof v.coords.latitude === "number" ? v.coords.latitude : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                   v.coords.latitude)
                                                                                                                                                                                                                                                                                                                                                                                   ,longitude: typeof v.coords.longitude === "number" ? v.coords.longitude : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                   v.coords.longitude)
                                                                                                                                                                                                                                                                                                                                                                                   ,speed: v.coords.speed === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v.coords.speed === "number" ? v.coords.speed : _U.badPort("a number",
                                                                                                                                                                                                                                                                                                                                                                                   v.coords.speed))} : _U.badPort("an object with fields `accuracy`, `altitude`, `altitudeAccuracy`, `heading`, `latitude`, `longitude`, `speed`",
                                                                                                                                                v.coords)
                                                                                                                                                ,timestamp: typeof v.timestamp === "number" ? v.timestamp : _U.badPort("a number",
                                                                                                                                                v.timestamp)} : _U.badPort("an object with fields `coords`, `timestamp`",
      v));
   });
   var orientationErrorSignal = Elm.Native.Port.make(_elm).inboundSignal("orientationErrorSignal",
   "Maybe.Maybe String",
   function (v) {
   ...
   var orientationSignal = Elm.Native.Port.make(_elm).inboundSignal("orientationSignal",
   "Maybe.Maybe Schema.Orientation",
   function (v) {
      return v === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v === "object" && "alpha" in v && "beta" in v && "gamma" in v ? {_: {}
                                                                                                                                                          ,alpha: v.alpha === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v.alpha === "number" ? v.alpha : _U.badPort("a number",
                                                                                                                                                          v.alpha))
                                                                                                                                                          ,beta: v.beta === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v.beta === "number" ? v.beta : _U.badPort("a number",
                                                                                                                                                          v.beta))
                                                                                                                                                          ,gamma: v.gamma === null ? Elm.Maybe.make(_elm).Nothing : Elm.Maybe.make(_elm).Just(typeof v.gamma === "number" ? v.gamma : _U.badPort("a number",
   ...
   var app = $StartApp.start({_: {}
                             ...
                             ,inputs: _L.fromArray([A2($Signal._op["<~"],
                                                   ...
                                                   ,A2($Signal._op["<~"],
                                                   function ($) {
                                                      return $Schema.ChangeOrientation($Maybe.map($Result.Err)($));
                                                   },
                                                   orientationErrorSignal)
                                                   ,A2($Signal._op["<~"],
                                                   function ($) {
                                                      return $Schema.ChangeLocation($Maybe.map($Result.Ok)($));
                                                   },
                                                   geolocationSignal)
                                                   ,A2($Signal._op["<~"],
                                                   function ($) {
                                                      return $Schema.ChangeLocation($Maybe.map($Result.Err)($));
                                                   },
                                                   geolocationErrorSignal)])
                             ,update: update
                             ,view: $View.rootView});
   var main = app.html;
...
Elm.Schema.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var FindAction = function (a) {
      return {ctor: "FindAction"
             ,_0: a};
   };
   var ChangeLocation = function (a) {
      return {ctor: "ChangeLocation"
             ,_0: a};
   };
   var ChangeOrientation = function (a) {
...
Elm.View.make = function (_elm) {
   ...
   var orientationErrorView = function (err) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("alert alert-warning")]),
      _L.fromArray([$Html.text(err)]));
   };
   var noOrientationView = A2($Html.h2,
   _L.fromArray([]),
   _L.fromArray([$Html.text("Awaiting orientation...")]));
   var noTargetView = A2($Html.h2,
   _L.fromArray([]),
   _L.fromArray([$Html.text("Error - no target found.")]));
   ...
   model) {
      return function () {
         var _v0 = {ctor: "_Tuple3"
                   ,_0: model.geolocation
                   ,_1: model.orientation
                   ,_2: model.findModel.chosenCandidate};
         switch (_v0.ctor)
         {case "_Tuple3":
            switch (_v0._0.ctor)
              {case "Nothing":
                 return noPositionView;}
              switch (_v0._1.ctor)
              {case "Nothing":
                 return noOrientationView;}
              switch (_v0._2.ctor)
              {case "Nothing":
                 return noTargetView;}
              switch (_v0._0.ctor)
              ...
              {case "Just":
                 switch (_v0._1._0.ctor)
                   {case "Err":
                      return orientationErrorView(_v0._1._0._0);}
                   break;}
              switch (_v0._0.ctor)
              {case "Just":
                 switch (_v0._0._0.ctor)
                                  ...
                                  {case "Just":
                                     return A2($Html.div,
                                       ...
                                       _L.fromArray([A3($View$Compass.compass,
                                                    ...
                                                    _v0._1._0._0)
                                                    ,A2($Html.button,
                                                    _L.fromArray([$Html$Attributes.$class("btn btn-lg btn-block btn-primary")
                                                                 ,A2($Html$Events.onClick,
                                                                 uiChannel,
                                                                 $Schema.FindAction($FindAddress$Schema.Reset))]),
                                                    _L.fromArray([$Html.text("Finish")]))]));}
                                  break;}
                             break;}
                        break;}
                   break;}
   ...
   var contentView = F2(function (uiChannel,
   model) {
      return A2($Html.div,
      _L.fromArray([]),
...
Elm.View = Elm.View || {};
Elm.View.Compass = Elm.View.Compass || {};
Elm.View.Compass.make = function (_elm) {
   "use strict";
   _elm.View = _elm.View || {};
   _elm.View.Compass = _elm.View.Compass || {};
   if (_elm.View.Compass.values)
   return _elm.View.Compass.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   orientation) {
      return function () {
         ...
         distance);
         return A2($Html.div,
         _L.fromArray([$Svg$Attributes.$class("compass")]),
         _L.fromArray([A2($Svg.svg,
         _L.fromArray([$Svg$Attributes.width("300")
                      ,$Svg$Attributes.height("300")
                      ,$Svg$Attributes.viewBox("0 0 120 120")]),
         _L.fromArray([A2($Svg.circle,
                      _L.fromArray([$Svg$Attributes.cx("60")
                      ...
                      _L.fromArray([]))
                      ,A2($Svg.path,
                      _L.fromArray([$Svg$Attributes.d("M 50 10 A 50 50 0 0 1 70 10")
                                   ,$Svg$Attributes.fill("none")
                      ...
                      _L.fromArray([]))
                      ,A2($Svg.polygon,
                      _L.fromArray([$Svg$Attributes.points("58,10 60,3 62,10")
                      ...
                      _L.fromArray([]))
                      ,A2($Svg.text$,
                      _L.fromArray([$Svg$Attributes.x("60")
                                   ,$Svg$Attributes.y("60")
   ...
   _elm.View.Compass.values = {_op: _op
                              ,compass: compass};
   return _elm.View.Compass.values;
};
